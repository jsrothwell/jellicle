...
var project     = 'jellicle', // Optional - Use your own project name here...
...
gulp.task('js', function() {
	return gulp.src([source+'js/vendor/**/*.js', source+'bower/**', source+'bower_components/materialize/dist/js/materialize.js', ])
...
// Move Fontawesome Icons to public/font
gulp.task('icons', function() {
    return gulp.src(bower + '/fontawesome/font/**.*')
        .pipe(gulp.dest(base+'/font'));
});

// Move bootstrap.min.js to assets/js
gulp.task('bootstrap-scripts', function() {
    return gulp.src(source+'/bower_components/twitter-bootstrap-sass/assets/javascripts/**.*')
        .pipe(gulp.dest(source+'/js'));
});

// Move bootstrap sass to assets/sass
gulp.task('bootstrap-styles', function() {
    return gulp.src(source+'/bower_components/twitter-bootstrap-sass/assets/stylesheets/**.*')
        .pipe(gulp.dest(source+'/sass'));
});

// Move bootstrap sass-dependencies to assets/sass
gulp.task('bootstrap-styles-deps', function() {
    return gulp.src(source+'/bower_components/twitter-bootstrap-sass/assets/stylesheets/bootstrap/**.*')
        .pipe(gulp.dest(source+'/sass/bootstrap'));
});

// Move bootstrap sass-mixins to assets/sass
gulp.task('bootstrap-styles-mixins', function() {
    return gulp.src(source+'/bower_components/twitter-bootstrap-sass/assets/stylesheets/bootstrap/mixins/**.*')
        .pipe(gulp.dest(source+'/sass/bootstrap/mixins'));
});
